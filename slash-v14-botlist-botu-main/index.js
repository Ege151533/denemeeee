...
client.login("MTA1MzM1Njg4MzkzMjYzMTExMQ.GOASwM.4LVnBIzJe27hznt-ozu4qfDlJgLTj_OuPI7yxc")
...
client.on('interactionCreate', async interaction => {
    ...
    if (interaction.customId === 'form') {
        ...
        const Discord = require("discord.js")
        const id = interaction.fields.getTextInputValue("1012008135147405434")
        const prefix = interaction.fields.getTextInputValue('.')
